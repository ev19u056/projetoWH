...
tmp = pd.read_csv('data/ttbar_nonallhad_PwPy8_ade.csv',nrows = int(nrows_ttbar*fraction))
print(missing_values_table(tmp[trainFeatures]))
del tmp

print("Reading -> 'WlvZqq_Sh221_ade.csv'")
tmp = pd.read_csv('data/WlvZqq_Sh221_ade.csv',nrows = int(nrows_WlvZqq*fraction))
print(missing_values_table(tmp[trainFeatures]))
del tmp

print("Reading -> 'WqqWlv_Sh221_ade.csv'")
tmp = pd.read_csv('data/WqqWlv_Sh221_ade.csv',nrows = int(nrows_WqqWlv*fraction))
print(missing_values_table(tmp[trainFeatures]))
del tmp

print("Reading -> 'WJets_Sh221.csv'")
tmp = pd.read_csv('data/WJets_Sh221.csv',nrows = int(fraction*nrows_Wjets))
print(missing_values_table(tmp[trainFeatures]))
del tmp
'''
