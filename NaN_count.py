...
def missing_values_table(df):
        ...
        mis_val_table_ren_columns = mis_val_table_ren_columns[mis_val_table_ren_columns.iloc[:,1] != 0].sort_values('% of Total Values', ascending=False)
...
nan_count = nan_count.append(tmp[trainFeatures].isna().sum(axis = 0))
del tmp
print(nan_count)
