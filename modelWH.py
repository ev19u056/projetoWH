...
if __name__ == "__main__":
    ...
    callbacks = [EarlyStopping(patience=10, verbose=True), ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=5, verbose=True, min_delta=0.0001, cooldown=0, min_lr=0), ModelCheckpoint(filepath+name+".h5", save_best_only=True, save_weights_only=True)]
    ...
    # Saving the trainned model and its weights
